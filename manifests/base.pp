class general{
    ...
    package { 
      [ "curl", "vim", "git-core", "subversion", "mercurial", "python", "python-setuptools", "python-dev", "build-essential", "python-pip", "python-virtualenv", "virtualenvwrapper", "libxml2-dev", "libxslt-dev", "libgeoip-dev", "gettext", "libmemcache-dev", "libmemcached-dev"]:
      ensure => ["installed"],
